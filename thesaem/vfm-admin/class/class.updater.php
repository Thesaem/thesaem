...
if (!class_exists('Updater', false)) {
    ...
    class Updater
    {
        ...
        public function init()
        {
            ...
            $posteditpass = filter_input(INPUT_POST, 'user_new_pass', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
            $posteditpasscheck = filter_input(INPUT_POST, 'user_new_pass_confirm', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
            $postoldpass = filter_input(INPUT_POST, 'user_old_pass', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
