...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($get_action == "new") {
        ...
        $postnewuserpass = filter_input(INPUT_POST, "newuserpass", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if ($get_action == "updatemaster") {
        ...
        $postuserpassnew = filter_input(INPUT_POST, "masteruserpassnew", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if ($get_action == "update") {
        ...
        $postuserpassnew = filter_input(INPUT_POST, "userpassnew", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
