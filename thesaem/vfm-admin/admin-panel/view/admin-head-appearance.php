...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    * Progress bar
    */
    $progressColor = filter_input(INPUT_POST, "progressColor", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    */
     ...
     * Audio notifications
     */
    $_CONFIG['audio_notification'] = empty($_POST['audio_notification']) ? false : filter_input(INPUT_POST, 'audio_notification', FILTER_SANITIZE_FULL_SPECIAL_CHARS);

    /**
    * App icon
    */
    $removeappico = filter_input(INPUT_POST, "remove_app_ico", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    */
    ...
    $removenavlogo = filter_input(INPUT_POST, "remove_navbar_logo", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    * Custom Header
    */
    $removelogo = filter_input(INPUT_POST, "remove_logo", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    $banner_width = filter_input(INPUT_POST, "banner_width", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
